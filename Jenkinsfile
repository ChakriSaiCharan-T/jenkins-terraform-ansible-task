            ...
            steps {
                script {
                   sleep '360'
                    ...
                    ansiblePlaybook becomeUser: 'ubuntu', credentialsId: 'ubuntuuser', disableHostKeyChecking: true, installation: 'ansible', inventory: '/var/lib/jenkins/workspace/task/jenkins-terraform-ansible-task/inventory.yaml', playbook: '/var/lib/jenkins/workspace/task/jenkins-terraform-ansible-task/ubuntu-playbook.yml', vaultTmpPath: ''
                }
            }
        }
    }
